...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative px-6 md:px-10 pt-32 pb-10 overflow-hidden">
      <div ref={wrapRef}>
        <p className="text-xs tracking-[0.3em] uppercase text-[var(--pink)] font-semibold mb-8">
          // Get in touch
        </p>

        <h2 className="font-display uppercase outline-text leading-[0.85] text-[clamp(3rem,14vw,11rem)] tracking-[-0.04em] -ml-1">
          LET'S
        </h2>
        <h2 className="font-display uppercase outline-text leading-[0.85] text-[clamp(3rem,14vw,11rem)] tracking-[-0.04em] -ml-1">
          BUILD
        </h2>
        <h2 className="font-display uppercase chrome-text leading-[0.85] text-[clamp(3rem,14vw,11rem)] tracking-[-0.04em] -ml-1">
          SOMETHING
        </h2>
        <h2 className="font-display uppercase text-[var(--acid)] leading-[0.85] text-[clamp(3rem,14vw,11rem)] tracking-[-0.04em] -ml-1 mb-16">
          INTELLIGENT.
        </h2>
